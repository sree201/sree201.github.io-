# Custom Domain Setup Guide: srinathkoyi.cloud

This guide will help you set up `srinathkoyi.cloud` as your custom domain for your GitHub Pages portfolio.

**Note**: For Hostinger-specific instructions, see `HOSTINGER_SETUP.md`

## Prerequisites

1. ✅ Your portfolio is deployed to GitHub Pages at `sree201.github.io`
2. ✅ You own the domain `srinathkoyi.cloud` (purchased from Hostinger)

## Step 1: Access Your Domain DNS Settings

You already own `srinathkoyi.cloud` from Hostinger. Now you need to configure DNS:

**For Hostinger-specific instructions, see `HOSTINGER_SETUP.md`**

### General Domain Registrars (if using different registrar):

### Recommended Registrars (for reference):
- **Hostinger**: https://www.hostinger.com (Your current registrar ✅)
...
3. Under **"Custom domain"**, enter: `srinathkoyi.cloud`
4. Click **"Save"**
...
- Don't manually edit this file unless you know what you're doing
   - The file should contain: `srinathkoyi.cloud`
...
- ✅ https://www.srinathkoyi.cloud (if you set up www subdomain)
...
1. Add another CNAME record:
   ...
   Type: CNAME
   Name: www
   Value: sree201.github.io (or srinathkoyi.github.io)
   ```

2. In GitHub Pages settings, you can add `www.srinathkoyi.cloud` as an additional domain

## Cost Summary

- **Domain**: Already purchased ✅ (srinathkoyi.cloud from Hostinger)
- **GitHub Pages**: Free
- **SSL Certificate**: Free (provided by GitHub)
- **Total**: Just domain renewal cost

---

**Your Custom Domain**: https://srinathkoyi.cloud

Once set up, this will be your professional portfolio URL!

**For Hostinger-specific setup instructions, see `HOSTINGER_SETUP.md`**
